    ...
    public class Vector3D
    {
        ...
        public class Vectors3DTest
        {
            public static void Main()
            {
                ...
                Console.WriteLine("Sum of two vectors ={0}", v1.Add());
                Console.WriteLine("Sub of two vectors = {0}", v1.Sub());
                Console.WriteLine("Scaler productation = {0}", v1.ScalerPro());
                Console.WriteLine("Scaler multiplication = {0}", v1.Multi());
                Console.WriteLine("Scaler multiplication = {0}", v1.Multi(3.0));
                Console.WriteLine(v1.Length());
                Console.WriteLine(v1.Comparelength());
                Console.WriteLine(v1.Comparisson());
